...
stDate getReturnDate(stDate dateStart , int vacationDays){
...
int main()
{
    ...
    cout << "Vacation Ends :\n";
    int vacationDays=input::readPositiveIntegerNumber("Enter vacation days? ");
    stDate returnDate = getReturnDate(dateStart,vacationDays);
    cout << "Return Date : " << arrDays[getToDayOrderInWeek(returnDate)] << " , " << convertDateToString(returnDate) << "\n\n";
