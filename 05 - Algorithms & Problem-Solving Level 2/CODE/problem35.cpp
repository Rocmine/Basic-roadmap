...
bool isNumberInArray(const int Array[50], const unsigned Length, const int SearchValue)
{

    return GetSearchValuePosition(Array, Length, SearchValue) != -1;
}

void printResult(const int Array[50], const unsigned Length, int SearchValue)
{

    cout << "Number you are looking for is :" << SearchValue << "\n";

    if (!isNumberInArray(Array, Length, SearchValue))
...
int main()
{
    ...
    printResult(Array, Length, SearchValue);
