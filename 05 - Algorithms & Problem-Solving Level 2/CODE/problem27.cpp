...
template <typename T >
auto GetAverageArray(T Array[], const unsigned Length)
{
 

    return float(GetSumArray(Array,Length))/Length;
}
...
int main()
{
    ...
    PrintResultOnScreen("Average Of Array is :", GetAverageArray(Array, Length));
