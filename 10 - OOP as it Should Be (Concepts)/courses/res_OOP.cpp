...
//syntax : 
 ...
 class className{ 
    friend datatype classb::functionName(arg); 
 }

void classb::functionName(){
...
// example : 
    ...
    public:
        ...
        /*
        In C++, when you declare a friend function inside a class, the compiler needs 
        to know the complete definition of the friend function's class
        */
 ...
 more about : https://stackoverflow.com/questions/10546391/specify-a-class-member-function-as-a-friend-of-another-class
